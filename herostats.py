...
f.write('\tpublic double turn;\n')
f.write('\tpublic ArrayList<Status> statuses;\n')
f.write('\tpublic ArrayList<Skill> skills;\n')
f.write('\tpublic boolean isStunned;\n')
f.write('\tpublic boolean isSleeped;\n')
f.write('\tpublic boolean isSilenced;\n')
f.write('\tpublic boolean isDisarmed;\n')
for a in attributes:
